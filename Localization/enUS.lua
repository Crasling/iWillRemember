...
L["CharNoteFactionMissing"] = " Faction information is missing, will be added the next time player is targeted."
L["CharNoteFactionUpdate"] = Colors.iWR .."] was found with missing faction in the iWR Database. Faction was added."
...
L["DescSimpleMenu"] = "|cFF808080Replaces the slider with configurable level buttons. Customize levels in the Customize tab.|r"
L["GoodLevels"] = "Positive Levels"
L["BadLevels"] = "Negative Levels"
L["SimpleLevelsHeader"] = Colors.iWR .. "Simple Menu Levels"
L["DescSimpleLevels"] = "|cFF808080Set the number of positive and negative levels for Simple Menu buttons. Icons and labels for each level can be customized below.|r"
L["RelationLevelsHeader"] = Colors.iWR .. "Relation Levels"
L["DescRelationLevels"] = "|cFF808080Set the number of positive and negative relation levels. The base levels (Superior, Respected, Liked, Disliked, Hated) are always present.|r"
...
L["ISTInstalledDesc"] = Colors.iWR .. "iSealTwist" .. Colors.Reset .. " is installed. Open its settings to configure the swing timer and twist window."
L["ISTOpenSettingsButton"] = "Open iST Settings"
L["ISTPromoHeader"] = Colors.iWR .. "iSealTwist"
L["ISTPromoDesc"] = Colors.iWR .. "iSealTwist" .. Colors.Reset .. " is a seal twist timing helper for TBC Paladins. Visual swing timer with latency-compensated twist window indicator. Time your seals perfectly."
